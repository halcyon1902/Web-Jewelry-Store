			...
			<form action="/shop/ManagerProductServlet" method="post">
				<table width="95%">
					...
					<tr>
						<td><b>Giá bán</b></td>
						<td>
							<!-- <input type="text" class="sedang price" name="gia"> --> <input
							type="text" class="textfield sedang price" name="gia" value=""
					...
					<tr>
						...
						<td><input type="text" class="textfield sedang buy"
							name="buy" value="${product.productBuy.longValue()}" id="extra7"
					...
					<tr>
						<td></td>
						<td><input type="hidden" class="command" name="command"
							value="insert"> <input class="button" value="Lưu dữ liệu"
							onclick="postFormData()"></td>
					</tr>
				</table>
			</form>
		</div>
