        ...
        <div class="container">
                ...
                <div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                    <ul>
                        <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>
                        	...
                        	<% } else {%>
                        		<a href="mailto: hutech@hutech.edu.vn">info@examle.com</a>
                        	<% }%> --%>
                        	<c:choose>
                        		...
                        		<c:otherwise>
                        			<a href="mailto: hutech@hutech.edu.vn"> hutech@hutech.edu.vn</a>
                        		</c:otherwise>
                        	</c:choose>
                        </li>
            ...
            <div class="logo-nav">
                <div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
                    <h1><a href="/shop/homepage">4TV<span>HUTECH STORE</span></a></h1>
                </div>
