		...
		<div id="rightContent">
			...
			<table class="data">
				<tr class="data">
					...
					<th class="data" width="80px">Nhà cung cấp</th>
				...
				<c:forEach items="${prods}" var="p" varStatus="loop">
					<tr class="data">
						...
						<td class="data"><img style="text-align: center" witdh="50px"
							height="50px" src="${p.productImage}" /></td>
						<td class="data"><fmt:formatNumber value="${p.productPrice}"
								type="currency" currencySymbol="" /> VNĐ</td>
						<td class="data"><fmt:formatNumber value="${p.productBuy}"
								type="currency" currencySymbol="" /> VNĐ</td>
